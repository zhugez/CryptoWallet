...
import { FiRefreshCw, FiPlus, FiCalendar, FiArrowDownLeft, FiArrowUpRight } from 'react-icons/fi';
                      ...
                      <div className="flex justify-between items-start">
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <Badge variant={transaction.transaction_type === 'deposit' ? 'success' : 'destructive'}>
                        ...
                        <div className="text-right space-y-2">
                          ...
                          <p className={`text-2xl font-bold ${transaction.transaction_type === 'deposit'
                            ? 'bg-gradient-to-r from-emerald-400 to-cyan-400'
                            : 'bg-gradient-to-r from-pink-400 to-red-400'
                            } bg-clip-text text-transparent`}>
                            {transaction.transaction_type === 'deposit' ? '+' : '-'}{formatAmount(transaction.amount)} ETH
                          </p>
